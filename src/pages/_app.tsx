      ...
      <nav className="flex w-full flex-col items-center bg-white">
        <div className="container flex items-center justify-between gap-6 px-4 py-6 text-lg font-bold sm:px-4">
          <div className="flex gap-6">
            ...
            <Link href="https://techfizu.robi.dev" className="group relative">
              Tech fizu
              <div className="line absolute bottom-0 left-0 block h-[1px] w-[1px] origin-left scale-x-0 border-t-2 border-t-slate-900 transition-all duration-300 group-hover:w-full group-hover:scale-x-[1]"></div>
            </Link>
          </div>
          ...
          <div className="flex gap-4">
            <Link
              href="https://github.com/gasparrobi/inflacio.robi.dev"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-team-current focus:text-team-curren text-primary focus:outline-none"
            >
              <svg
                width="24"
                height="24"
                fill="none"
                viewBox="0 0 24 24"
                className="fill-slate-800 transition-colors duration-200 ease-in-out hover:fill-slate-600"
              >
                <title>GitHub</title>
            ...
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-team-current focus:text-team-current text-primary focus:outline-none"
            >
              <svg
                width="24"
                height="24"
